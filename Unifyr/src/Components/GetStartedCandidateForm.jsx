...
const GetStartedCandidateForm = () => {
  ...
  const pages = [
    ...
    },
    {
      ...
      icon: FaFileAlt,
      description: 'Detail your research and publications.',
      fields: [
        'researchPapers',
    ...
    },
    {
      ...
      icon: FaHeart,
      description: 'Let us know your areas of interest.',
      fields: ['areasOfInterest', 'preferredJobPostings'],
    },
    {
      title: 'Matching Criteria',
      icon: FaInfoCircle,
      description: 'Provide your matching criteria.',
      fields: [
        'preferredLocation',
    ...
    },
    {
      ...
      fields: [
        'interestInDRDO',
        'uniqueSkillsOrExperiences',
        'specificProjectsOrAreas',
        'additionalNotes',
      ],
    },
    {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Main Content */}
      <div className="flex-1 flex mt-20"> {/* Adjusted margin to consider navbar height */}
        {/* Sidebar */}
        <div className="w-1/4 bg-gray-100 border-r border-gray-200 p-4 hidden md:block">
        ...
        <div className="flex-1 px-4 py-10">
          <animated.div
            style={fadeInScale}
            className="bg-white shadow-2xl mt-4 rounded-lg p-8 max-w-2xl mx-auto border border-gray-200 relative"
          >
            {/* Progress Indicator */}
