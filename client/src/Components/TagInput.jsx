...
return (
    ...
    <label class="block text-base text-gray"></label>
    <div className="flex flex-wrap mb-2 gap-2 text-white font-medium">
        {tags.map((tag, index) => (
        <div
            key={index}
    ...
    <input
        ...
        onPaste={handlePaste}
        className="block w-full px-5 py-2.5 text-black placeholder-gray-400 bg-transparent border border-gray-200 rounded-lg"
    />
    </div>
);
};
